...
#include "XunoSimpleFilter.h"
#include <QWidget>
#include <math.h>

namespace QtAV {

XunoSimpleFilter::XunoSimpleFilter(QObject *parent):
    VideoFilter(parent)
  , mCanRot(true)
  , mWave(true)
{
...
XunoSimpleFilter::~XunoSimpleFilter()
{
}

void XunoSimpleFilter::enableRotate(bool r)
{
    mCanRot = r;
}

void XunoSimpleFilter::enableWaveEffect(bool w)
{
    mWave = w;
}

void XunoSimpleFilter::setText(const QString &text)
{
    mText = text;
}

QString XunoSimpleFilter::text() const
{
    return mText;
}

void XunoSimpleFilter::setImage(const QImage &img)
{
    mImage = img;
}

void XunoSimpleFilter::prepare()
{
...
void XunoSimpleFilter::timerEvent(QTimerEvent *)
{
    if (qobject_cast<QWidget*>(parent()))
        ((QWidget*)parent())->update();
}

void XunoSimpleFilter::process(Statistics *statistics, VideoFrame *frame)
{
    Q_UNUSED(statistics);
    Q_UNUSED(frame);
    if (!isEnabled())
