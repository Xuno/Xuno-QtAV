...
void main()
{
    ...
    _tc = _tc/TextureSize;
    _c0283 = (_tc - _dx) - _dy;
    _TMP17 = COMPAT_TEXTURE(Texture0, _c0283);
    _c0285 = _tc - _dy;
    _TMP18 = COMPAT_TEXTURE(Texture0, _c0285);
    _c0287 = (_tc + _dx) - _dy;
    _TMP19 = COMPAT_TEXTURE(Texture0, _c0287);
    _c0289 = (_tc + 2.00000000E+00*_dx) - _dy;
    _TMP20 = COMPAT_TEXTURE(Texture0, _c0289);
    _c0291 = _tc - _dx;
    _TMP21 = COMPAT_TEXTURE(Texture0, _c0291);
    _TMP22 = COMPAT_TEXTURE(Texture0, _tc);
    _c0295 = _tc + _dx;
    _TMP23 = COMPAT_TEXTURE(Texture0, _c0295);
    _c0297 = _tc + 2.00000000E+00*_dx;
    _TMP24 = COMPAT_TEXTURE(Texture0, _c0297);
    _c0299 = (_tc - _dx) + _dy;
    _TMP25 = COMPAT_TEXTURE(Texture0, _c0299);
    _c0301 = _tc + _dy;
    _TMP26 = COMPAT_TEXTURE(Texture0, _c0301);
    _c0303 = _tc + _dx + _dy;
    _TMP27 = COMPAT_TEXTURE(Texture0, _c0303);
    _c0305 = _tc + 2.00000000E+00*_dx + _dy;
    _TMP28 = COMPAT_TEXTURE(Texture0, _c0305);
    _c0307 = (_tc - _dx) + 2.00000000E+00*_dy;
    _TMP29 = COMPAT_TEXTURE(Texture0, _c0307);
    _c0309 = _tc + 2.00000000E+00*_dy;
    _TMP30 = COMPAT_TEXTURE(Texture0, _c0309);
    _c0311 = _tc + _dx + 2.00000000E+00*_dy;
    _TMP31 = COMPAT_TEXTURE(Texture0, _c0311);
    _c0313 = _tc + 2.00000000E+00*_dx + 2.00000000E+00*_dy;
    _TMP32 = COMPAT_TEXTURE(Texture0, _c0313);
